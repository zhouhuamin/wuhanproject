...
CCLM50034::CCLM50034(void) : m_messageHead(), m_billInfo(), m_respondInfo(), m_chOpFlag('F'), \
m_chSEND_FLAG('1'), m_strNote(""),m_contaInfoVect(0)
{
}

CCLM50034::~CCLM50034(void)
{
}

void CCLM50034::InitConfigInfo(structConfigInfo *pConfig)
{
...
void CCLM50034::SaveFileName(const std::string &strFileName)
{
...
void CCLM50034::SendResponse(const std::string &strPreFlag)
{
	LOG1("CCLM50034::SendResponse:%s", strPreFlag.c_str());
	...
	for (int i = 0, j = 0; i < queueNameArray.GetSize() && j < mqIPArray.GetSize(); ++i,++j)
	{
		...
		std::string szLabel			= CMessageType::CLM50034;
...
std::string CCLM50034::GetFileName()
{
	return m_strFileName;
}

int CCLM50034::SelectMQ(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
...
int CCLM50034::SelectResponseInfo(CString &strMESSAGE_ID, CString &strOP_FLAG, CString &strNOTE)
{
...
int CCLM50034::InsertResponseInfo()
{
	if (m_respondInfo.MESSAGE_ID[0] == '\0')
		return 0;
...
int CCLM50034::DeleteResponseInfo()
{
	if (m_respondInfo.MESSAGE_ID[0] == '\0')
		return 0;
