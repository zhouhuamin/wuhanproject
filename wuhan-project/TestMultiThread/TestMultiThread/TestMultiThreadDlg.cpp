...
CTestMultiThreadDlg::CTestMultiThreadDlg(CWnd* pParent /*=NULL*/)
...
BEGIN_MESSAGE_MAP(CTestMultiThreadDlg, CDialog)
	...
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
	ON_BN_CLICKED(IDC_BUTTON1, &CTestMultiThreadDlg::OnBnClickedButton1)
	ON_BN_CLICKED(IDC_BUTTON2, &CTestMultiThreadDlg::OnBnClickedButton2)
END_MESSAGE_MAP()
...
void CTestMultiThreadDlg::OnBnClickedButton2()
{
	// TODO: 在此添加控件通知处理程序代码
	job.ShutDown();
}
