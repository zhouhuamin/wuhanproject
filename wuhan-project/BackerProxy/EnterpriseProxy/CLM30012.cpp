...
CCLM30012::CCLM30012(void) : m_messageHead(), m_billInfo(), m_respondInfo(), m_chOpFlag('F'), \
m_chSEND_FLAG('1'), m_strNote(""),m_contaInfoVect(0)
{
}

CCLM30012::~CCLM30012(void)
{
}

void CCLM30012::InitConfigInfo(structConfigInfo *pConfig)
{
...
void CCLM30012::SaveFileName(const std::string &strFileName)
{
...
void CCLM30012::SendResponse(const std::string &strPreFlag)
{
	LOG1("CCLM30012::SendResponse:%s", strPreFlag.c_str());
	// 海关平台返回的回执
	if (strPreFlag == "WEB")
	{
...
std::string CCLM30012::GetFileName()
{
	return m_strFileName;
}

int CCLM30012::SelectMQ(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
...
int CCLM30012::SelectResponseInfo(CString &strMESSAGE_ID, CString &strOP_FLAG, CString &strNOTE)
{
...
int CCLM30012::InsertResponseInfo()
{
	if (m_respondInfo.MESSAGE_ID[0] == '\0')
		return 0;
...
int CCLM30012::DeleteResponseInfo()
{
	if (m_respondInfo.MESSAGE_ID[0] == '\0')
		return 0;
...
int CCLM30012::SelectMQForWeb(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
		CStringArray mqPathArray;
