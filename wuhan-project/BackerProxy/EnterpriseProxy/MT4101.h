...
private:
	...
	int SelectMQForWeb(CStringArray &queueNameArray, CStringArray &mqIPArray, char INOROUTFLAG);
	int SelectMQForQiYe(CStringArray &queueNameArray, CStringArray &mqIPArray);
	int SelectMQForCustom(CStringArray &queueNameArray, CStringArray &mqIPArray, char INOROUTFLAG);
