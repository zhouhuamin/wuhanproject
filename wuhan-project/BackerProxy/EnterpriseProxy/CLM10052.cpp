...
CCLM10052::CCLM10052(void) : m_messageHead(), m_billInfo(), m_respondInfo(), m_chOpFlag('F'), \
m_chSEND_FLAG('1'), m_strNote(""),m_contaInfoVect(0)
{
}

CCLM10052::~CCLM10052(void)
{
}

void CCLM10052::InitConfigInfo(structConfigInfo *pConfig)
{
...
void CCLM10052::SaveFileName(const std::string &strFileName)
{
...
void CCLM10052::SendResponse(const std::string &strPreFlag)
{
	LOG1("CCLM10052::SendResponse:%s", strPreFlag.c_str());
...
std::string CCLM10052::GetFileName()
{
	return m_strFileName;
}

int CCLM10052::SelectMQ(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
...
int CCLM10052::SelectResponseInfo(CString &strMESSAGE_ID, CString &strOP_FLAG, CString &strNOTE)
{
...
int CCLM10052::InsertResponseInfo()
{
	if (m_respondInfo.MESSAGE_ID[0] == '\0')
		return 0;
...
int CCLM10052::DeleteResponseInfo()
{
	if (m_respondInfo.MESSAGE_ID[0] == '\0')
		return 0;
