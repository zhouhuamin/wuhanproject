...
public:
	...
	static const std::string CLM90051;
	static const std::string CLM90052;
	static const std::string CLM80011;
	static const std::string CLM80012;
	static const std::string CLM20023;	
	static const std::string CLM20024;
	static const std::string CLM20033;	
	static const std::string CLM20034;
	static const std::string CLM32101;

	static const std::string CLM24101;
	static const std::string CLM74102;
};
