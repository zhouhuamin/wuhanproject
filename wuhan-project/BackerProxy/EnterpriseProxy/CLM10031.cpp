...
CCLM10031::CCLM10031(void) : m_messageHead(), m_billInfo(), m_respondInfo(), m_chOpFlag('F'), \
...
void CCLM10031::SendResponse(const std::string &strPreFlag)
{
	LOG1("CCLM10031::SendResponse:%s", strPreFlag.c_str());
...
int CCLM10031::SelectMQ(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
