...
void CCLM90031::SendResponse(const std::string &strPreFlag)
{
	LOG1("CCLM90031::SendResponse:%s", strPreFlag.c_str());
	// WEB应用发送
	if (strPreFlag == "WEB")
	{
...
int CCLM90031::SelectMQ(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
