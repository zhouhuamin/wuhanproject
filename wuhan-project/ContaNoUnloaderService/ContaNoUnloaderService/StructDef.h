...
{
	char MESSAGE_ID[40 + 1];	// 报文编号
	char OP_FLAG[4 + 1];		// 入库标志 T:成功, F:失败
	char NOTE[255 + 1];			// 备注
};
...
struct structSHIP_INFO_CLM10041
{
	...
	std::string LOADING_LOCATION_ID;
	std::string UNLOADING_LOCATION_ID;
};
...
{
	std::string			BILL_NO;	// 
	std::vector<structCONTAINER_INFO_CLM10041> CONTAINER_INFO;
};
...
struct structCOMPANY_INFO_CLM90031
{
	...
	std::string CORP_CODE;
	std::string CORP_ID;
	std::string CORP_NAME;
	std::string LEGAL_REPRESENT;
	char		CORP_TYPE;
	std::string CORP_ADDR;
	std::string FAX_NUM;
	std::string TEL_NUM;
	...
	std::string AVAIL_TIME;
	std::string REG_AUTH;
	std::vector<std::string> PORT_ID;

};

struct structPORT_INFO_CLM90051
{
	...
	int		GATEWAY_PORT;
	std::string CONTACT_CODE;
	std::string CUSTOMS_CODE;
	std::string PASS_WORD;
	std::string CONTENT;
};

struct structNOTICE_INFO_CLM80011
{
...
struct structSHIP_INFO_CLM32101
{
	std::string CUSTOMS_CODE;	// 海关代码
	std::string SHIP_ID;
	std::string SHIP_NAME_EN;	// 运输工具名称
	std::string SHIP_NAME_CN;
	std::string VOYAGE_NO;		// 航次/班
	std::string NOTE;			// 备注
};

struct structCONTAINER_INFO_CLM32101
{
	std::string CONTA_NO;		// 集装箱号
	std::string CONTA_MODEL;	// 规格类型
	std::string CONTA_SIZE;		// 箱尺寸
...
struct structBILL_INFO_CLM32101
{
	std::string			BILL_NO;	// 
	std::string			PACK_NO;
	std::string			GROSS_WT;
	std::string			LOADINGLOCATION_ID;
	std::string			UNLOADINGLOCATION_ID;
	std::string			ARRIVALDATE;
	std::vector<structCONTAINER_INFO_CLM32101> CONTAINER_INFO;
	std::string			NOTE;		// 备注
};
