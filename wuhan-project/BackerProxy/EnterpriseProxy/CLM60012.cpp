...
CCLM60012::CCLM60012(void) : m_messageHead(), m_billInfo(), m_respondInfo(), m_chOpFlag('F'), \
m_chSEND_FLAG('1'), m_strNote(""),m_contaInfoVect(0)
{
}

CCLM60012::~CCLM60012(void)
{
}

void CCLM60012::InitConfigInfo(structConfigInfo *pConfig)
{
...
void CCLM60012::SaveFileName(const std::string &strFileName)
{
...
void CCLM60012::SendResponse(const std::string &strPreFlag)
{
	LOG1("CCLM60012::SendResponse:%s", strPreFlag.c_str());
	// 海关平台返回的回执
	if (strPreFlag == "WEB")
	{
...
std::string CCLM60012::GetFileName()
{
	return m_strFileName;
}

int CCLM60012::SelectMQ(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
...
int CCLM60012::SelectResponseInfo(CString &strMESSAGE_ID, CString &strOP_FLAG, CString &strNOTE)
{
...
int CCLM60012::InsertResponseInfo()
{
	if (m_respondInfo.MESSAGE_ID[0] == '\0')
		return 0;
...
int CCLM60012::DeleteResponseInfo()
{
	if (m_respondInfo.MESSAGE_ID[0] == '\0')
		return 0;
...
int CCLM60012::SelectMQForWeb(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
		CStringArray mqPathArray;
