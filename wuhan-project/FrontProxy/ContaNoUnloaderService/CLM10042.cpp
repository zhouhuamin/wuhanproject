...
CCLM10042::CCLM10042(void) : m_messageHead(), m_billInfo(), m_respondInfo(), m_chOpFlag('F'), \
m_chSEND_FLAG('1'), m_strNote(""),m_contaInfoVect(0)
{
}

CCLM10042::~CCLM10042(void)
{
}

void CCLM10042::InitConfigInfo(structConfigInfo *pConfig)
{
...
void CCLM10042::SaveFileName(const std::string &strFileName)
{
...
void CCLM10042::SendResponse()
{
	LOG3("Enter CCLM10042::SendResponse, MessageType:%s, Sender:%s, Receiver:%s", m_messageHead.MESSAGE_TYPE, m_messageHead.SENDER, m_messageHead.RECEIVE);
...
std::string CCLM10042::GetFileName()
{
	return m_strFileName;
}

int CCLM10042::SelectMQ(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
...
int CCLM10042::SelectResponseInfo(CString &strMESSAGE_ID, CString &strOP_FLAG, CString &strNOTE)
{
...
int CCLM10042::InsertResponseInfo()
{
	if (m_respondInfo.MESSAGE_ID[0] == '\0')
		return 0;
...
int CCLM10042::DeleteResponseInfo()
{
	if (m_respondInfo.MESSAGE_ID[0] == '\0')
		return 0;
