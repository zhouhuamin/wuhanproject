...
void CCLM20021::SendResponse(const std::string &strPreFlag)
{
	LOG2("CCLM20021::SendResponse:%s,%s", strPreFlag.c_str(),m_messageHead.MESSAGE_TYPE);
	// WEB应用发送
	if (strPreFlag == "WEB")
	{
		...
		szLabel += m_messageHead.MESSAGE_TYPE; // CMessageType::CLM20021;
...
int CCLM20021::SelectMQ(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
