...
#define SZAPPNAME            "WebProxyService"
// internal name of the service
#define SZSERVICENAME        "WebProxyService_Service"
// displayed name of the service
#define SZSERVICEDISPLAYNAME "WebProxyService  Service"
// list of service dependencies - "dep1\0dep2\0\0"
#define SZDEPENDENCIES       ""
#define SZSERVICECOMMENT "WEB报文转发数据服务"
...
void ReadConfigInfo(struct structConfigInfo &configInfo)
{
	...
	LOG4("%s, %s, %s, %s", strSSDataUserHandle.c_str(), strSSDataPwdHandle.c_str(), strSSDataNameHandle.c_str(), strSSDataServerHandle.c_str());
}
			...
			if (hFileFind != INVALID_HANDLE_VALUE)
			{
				do
				{
					...
					if (!(finder.dwFileAttributes & FILE_ATTRIBUTE_DIRECTORY))
					{
						...
						if (strMessageType.IsEmpty())
						{
							g_job.GetMessageTypeKy(strFileName, strMessageType);
						}
