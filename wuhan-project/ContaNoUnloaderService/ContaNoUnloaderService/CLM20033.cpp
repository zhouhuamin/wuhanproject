...
CCLM20033::CCLM20033(void) : m_messageHead(), m_clm20013(), m_respondInfo(), m_chOpFlag('F'), \
m_chSEND_FLAG('1'), m_strNote(""),m_contaInfoVect(0)
{
}

CCLM20033::~CCLM20033(void)
{
}

void CCLM20033::InitConfigInfo(structConfigInfo *pConfig)
{
...
void CCLM20033::SaveFileName(const std::string &strFileName)
{
...
int CCLM20033::SaveToDB()
{
	LOG("Enter CCLM20033::SaveToDB");
	...
	try
	{
		...
		if (m_messageHead.MESSAGE_ID[0] != '\0')
		{
			...
			sprintf_s(szSqlBuffer, sizeof(szSqlBuffer), "update D_RELEASE_APPLY_BILL set AUDIT_FLAG = '%c', AUDIT_DATE=GetDate(), AUDIT_NOTE='%s' where MESSAGE_ID='%s'", \
OP_FLAG,
m_clm20013.NOTE,
m_messageHead.MESSAGE_ID);
			...
			LOG1("update D_RELEASE_APPLY_BILL, MESSAGE_ID=%s", m_messageHead.MESSAGE_ID);
		}
	}
	catch(...)
	{
...
void CCLM20033::SendResponse()
{
	...
	std::string MESSAGE_TYPE = CMessageType::CLM20034;
...
std::string CCLM20033::GetFileName()
{
	return m_strFileName;
}

int CCLM20033::SelectMQ()
{
	if (m_messageHead.MESSAGE_ID[0] == '\0')
		return 0;
	...
	{
		CString strMQPath = "";
		std::string MQMessageType = CMessageType::CLM20033;
		char szSql[1024] = {0};
...
int CCLM20033::SelectMQForWeb(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
...
void CCLM20033::UTF8ToGBK( char *&szOut )
{
