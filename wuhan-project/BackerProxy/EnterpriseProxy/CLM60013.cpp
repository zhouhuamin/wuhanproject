...
void CCLM60013::SendResponse(const std::string &strPreFlag)
{
	LOG1("CCLM60013::SendResponse:%s", strPreFlag.c_str());
...
int CCLM60013::SelectMQ(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
