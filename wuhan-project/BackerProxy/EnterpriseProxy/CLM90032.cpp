...
CCLM90032::CCLM90032(void) : m_messageHead(), m_billInfo(), m_respondInfo(), m_chOpFlag('F'), \
m_chSEND_FLAG('1'), m_strNote(""),m_contaInfoVect(0)
{
}

CCLM90032::~CCLM90032(void)
{
}

void CCLM90032::InitConfigInfo(structConfigInfo *pConfig)
{
...
void CCLM90032::SaveFileName(const std::string &strFileName)
{
...
void CCLM90032::SendResponse(const std::string &strPreFlag)
{
	LOG1("CCLM90032::SendResponse:%s", strPreFlag.c_str());
	// 海关平台返回的回执
	if (strPreFlag == "WEB")
	{
...
std::string CCLM90032::GetFileName()
{
	return m_strFileName;
}

int CCLM90032::SelectMQ(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
...
int CCLM90032::SelectResponseInfo(CString &strMESSAGE_ID, CString &strOP_FLAG, CString &strNOTE)
{
...
int CCLM90032::InsertResponseInfo()
{
	if (m_respondInfo.MESSAGE_ID[0] == '\0')
		return 0;
...
int CCLM90032::DeleteResponseInfo()
{
	if (m_respondInfo.MESSAGE_ID[0] == '\0')
		return 0;
...
int CCLM90032::SelectMQForWeb(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
		CStringArray mqPathArray;
