...
void CMT4101::SendResponse(const std::string &strPreFlag)
{
	LOG2("CMT4101::SendResponse:%s--%s", m_mtResponse.Declaration.BorderTransportMeans.JourneyID.c_str(), strPreFlag.c_str());
	//if (m_messageHead.MESSAGE_ID[0] == '\0')
	//	return;
	...
	else if (!m_mtResponse.Declaration.BorderTransportMeans.JourneyID.empty() && strPreFlag == "WEB")
	{
		...
		//CStringArray queueNameArray;
		//CStringArray mqIPArray;
		//SelectMQForWeb(queueNameArray, mqIPArray, INOROUTFLAG);
	...
	if (strPreFlag == "WEB")
	{
		...
		//CStringArray queueNameArray;
		//CStringArray mqIPArray;
		//SelectMQForCustom(queueNameArray, mqIPArray, INOROUTFLAG);
...
int CMT4101::SelectMQ(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	...
	try
	{
		...
		CString strMQPath = "";
		char szSql[1024] = {0};
		sprintf_s(szSql, sizeof(szSql), "select MQPATH from WH_MQPATH_CONFIG where MQMESSAGETYPE='ALL' and CUSTOMS_CODE='%s' and ENTERPRISE_CODE='WEB-CUSTOM' and INOROUTFLAG='1'", m_mt4101.Head.ReceiverID.c_str());
...
int CMT4101::SelectMQForWeb(CStringArray &queueNameArray, CStringArray &mqIPArray, char INOROUTFLAG)
{
	try
	{
		CStringArray mqPathArray;
		CString strMQPath = "";
		char szSql[1024] = {0};
		sprintf_s(szSql, sizeof(szSql), "select MQPATH from WH_MQPATH_CONFIG where MQMESSAGETYPE='ALL' and CUSTOMS_CODE='%s' and ENTERPRISE_CODE='WEB' and INOROUTFLAG='%c'", m_mt4101.Head.ReceiverID.c_str(), INOROUTFLAG);
...
int CMT4101::SelectMQForQiYe(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
		CStringArray mqPathArray;
...
int CMT4101::SelectMQForCustom(CStringArray &queueNameArray, CStringArray &mqIPArray, char INOROUTFLAG)
{
	try
	{
		CStringArray mqPathArray;
		CString strMQPath = "";
		char szSql[1024] = {0};
		sprintf_s(szSql, sizeof(szSql), "select MQPATH from WH_MQPATH_CONFIG where MQMESSAGETYPE='ALL' and CUSTOMS_CODE='%s' and ENTERPRISE_CODE='CUSTOM' and INOROUTFLAG='%c'", m_mt4101.Head.ReceiverID.c_str(), INOROUTFLAG);
