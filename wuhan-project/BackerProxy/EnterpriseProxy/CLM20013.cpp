...
void CCLM20013::SendResponse(const std::string &strPreFlag)
{
	LOG1("CCLM20013::SendResponse:%s", strPreFlag.c_str());
	// WEB应用发送
	if (strPreFlag == "WEB")
	{
...
int CCLM20013::SelectMQ(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
