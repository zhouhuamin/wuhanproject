...
CCLM60014::CCLM60014(void) : m_messageHead(), m_billInfo(), m_respondInfo(), m_chOpFlag('F'), \
m_chSEND_FLAG('1'), m_strNote(""),m_contaInfoVect(0)
{
}

CCLM60014::~CCLM60014(void)
{
}

void CCLM60014::InitConfigInfo(structConfigInfo *pConfig)
{
...
void CCLM60014::SaveFileName(const std::string &strFileName)
{
...
void CCLM60014::SendResponse(const std::string &strPreFlag)
{
	LOG1("CCLM60014::SendResponse:%s", strPreFlag.c_str());
...
std::string CCLM60014::GetFileName()
{
	return m_strFileName;
}

int CCLM60014::SelectMQ(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
...
int CCLM60014::SelectResponseInfo(CString &strMESSAGE_ID, CString &strOP_FLAG, CString &strNOTE)
{
...
int CCLM60014::InsertResponseInfo()
{
	if (m_respondInfo.MESSAGE_ID[0] == '\0')
		return 0;
...
int CCLM60014::DeleteResponseInfo()
{
	if (m_respondInfo.MESSAGE_ID[0] == '\0')
		return 0;
