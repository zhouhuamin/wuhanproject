...
CCLM10041::CCLM10041(void) : m_messageHead(), m_billInfo(), m_respondInfo(), m_chOpFlag('F'), \
...
void CCLM10041::SendResponse(const std::string &strPreFlag)
{
	LOG1("CCLM10041::SendResponse:%s", strPreFlag.c_str());
	// WEB应用发送
	if (strPreFlag == "WEB")
	{
