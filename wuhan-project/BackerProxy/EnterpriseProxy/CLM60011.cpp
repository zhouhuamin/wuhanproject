...
void CCLM60011::SendResponse(const std::string &strPreFlag)
{
	LOG1("CCLM60011::SendResponse:%s", strPreFlag.c_str());
	// WEB应用发送
	if (strPreFlag == "WEB")
	{
...
int CCLM60011::SelectMQ(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
