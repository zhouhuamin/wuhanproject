...
void CCLM30011::SendResponse(const std::string &strPreFlag)
{
	LOG1("CCLM30011::SendResponse:%s", strPreFlag.c_str());
	// WEB应用发送
	if (strPreFlag == "WEB")
	{
...
int CCLM30011::SelectMQ(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
