...
CCLM50012::CCLM50012(void) : m_messageHead(), m_billInfo(), m_respondInfo(), m_chOpFlag('F'), \
m_chSEND_FLAG('1'), m_strNote(""),m_contaInfoVect(0)
{
}

CCLM50012::~CCLM50012(void)
{
}

void CCLM50012::InitConfigInfo(structConfigInfo *pConfig)
{
...
void CCLM50012::SaveFileName(const std::string &strFileName)
{
...
void CCLM50012::SendResponse(const std::string &strPreFlag)
{
	LOG1("CCLM50012::SendResponse:%s", strPreFlag.c_str());
	...
	for (int i = 0, j = 0; i < queueNameArray.GetSize() && j < mqIPArray.GetSize(); ++i,++j)
	{
		...
		std::string szLabel			= CMessageType::CLM50012;
...
std::string CCLM50012::GetFileName()
{
	return m_strFileName;
}

int CCLM50012::SelectMQ(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
...
int CCLM50012::SelectResponseInfo(CString &strMESSAGE_ID, CString &strOP_FLAG, CString &strNOTE)
{
...
int CCLM50012::InsertResponseInfo()
{
	if (m_respondInfo.MESSAGE_ID[0] == '\0')
		return 0;
...
int CCLM50012::DeleteResponseInfo()
{
	if (m_respondInfo.MESSAGE_ID[0] == '\0')
		return 0;
