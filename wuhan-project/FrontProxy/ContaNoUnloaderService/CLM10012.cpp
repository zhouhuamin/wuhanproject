...
CCLM10012::CCLM10012(void) : m_messageHead(), m_billInfo(), m_respondInfo(), m_chOpFlag('F'), \
m_chSEND_FLAG('1'), m_strNote(""),m_contaInfoVect(0)
{
}

CCLM10012::~CCLM10012(void)
{
}

void CCLM10012::InitConfigInfo(structConfigInfo *pConfig)
{
...
void CCLM10012::SaveFileName(const std::string &strFileName)
{
...
void CCLM10012::SendResponse()
{
	LOG3("Enter CCLM10012::SendResponse, MessageType:%s, Sender:%s, Receiver:%s", m_messageHead.MESSAGE_TYPE, m_messageHead.SENDER, m_messageHead.RECEIVE);
...
std::string CCLM10012::GetFileName()
{
	return m_strFileName;
}

int CCLM10012::SelectMQ(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
...
int CCLM10012::SelectResponseInfo(CString &strMESSAGE_ID, CString &strOP_FLAG, CString &strNOTE)
{
...
int CCLM10012::InsertResponseInfo()
{
	if (m_respondInfo.MESSAGE_ID[0] == '\0')
		return 0;
...
int CCLM10012::DeleteResponseInfo()
{
	if (m_respondInfo.MESSAGE_ID[0] == '\0')
		return 0;
