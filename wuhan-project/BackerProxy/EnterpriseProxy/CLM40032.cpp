...
CCLM40032::CCLM40032(void) : m_messageHead(), m_billInfo(), m_respondInfo(), m_chOpFlag('F'), \
m_chSEND_FLAG('1'), m_strNote(""),m_contaInfoVect(0)
{
}

CCLM40032::~CCLM40032(void)
{
}

void CCLM40032::InitConfigInfo(structConfigInfo *pConfig)
{
...
void CCLM40032::SaveFileName(const std::string &strFileName)
{
...
void CCLM40032::SendResponse(const std::string &strPreFlag)
{
	LOG1("CCLM40032::SendResponse:%s", strPreFlag.c_str());
	// 海关平台返回的回执
	if (strPreFlag == "WEB")
	{
...
std::string CCLM40032::GetFileName()
{
	return m_strFileName;
}

int CCLM40032::SelectMQ(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
...
int CCLM40032::SelectResponseInfo(CString &strMESSAGE_ID, CString &strOP_FLAG, CString &strNOTE)
{
...
int CCLM40032::InsertResponseInfo()
{
	if (m_respondInfo.MESSAGE_ID[0] == '\0')
		return 0;
...
int CCLM40032::DeleteResponseInfo()
{
	if (m_respondInfo.MESSAGE_ID[0] == '\0')
		return 0;
...
int CCLM40032::SelectMQForWeb(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
		CStringArray mqPathArray;
