...
CCLM10022::CCLM10022(void) : m_messageHead(), m_billInfo(), m_respondInfo(), m_chOpFlag('F'), \
m_chSEND_FLAG('1'), m_strNote(""),m_contaInfoVect(0)
{
}

CCLM10022::~CCLM10022(void)
{
}

void CCLM10022::InitConfigInfo(structConfigInfo *pConfig)
{
...
void CCLM10022::SaveFileName(const std::string &strFileName)
{
...
void CCLM10022::SendResponse()
{
	LOG3("Enter CCLM10022::SendResponse, MessageType:%s, Sender:%s, Receiver:%s", m_messageHead.MESSAGE_TYPE, m_messageHead.SENDER, m_messageHead.RECEIVE);
...
std::string CCLM10022::GetFileName()
{
	return m_strFileName;
}

int CCLM10022::SelectMQ(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
...
int CCLM10022::SelectResponseInfo(CString &strMESSAGE_ID, CString &strOP_FLAG, CString &strNOTE)
{
...
int CCLM10022::InsertResponseInfo()
{
	if (m_respondInfo.MESSAGE_ID[0] == '\0')
		return 0;
...
int CCLM10022::DeleteResponseInfo()
{
	if (m_respondInfo.MESSAGE_ID[0] == '\0')
		return 0;
