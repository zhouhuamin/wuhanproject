...
void CCLM40031::SendResponse(const std::string &strPreFlag)
{
	LOG1("CCLM40031::SendResponse:%s", strPreFlag.c_str());
	// WEB应用发送
	if (strPreFlag == "WEB")
	{
...
int CCLM40031::SelectMQ(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
