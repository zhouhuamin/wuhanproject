...
void CCLM20022::SendResponse(const std::string &strPreFlag)
{
	LOG2("CCLM20022::SendResponse:%s,%s", strPreFlag.c_str(),m_messageHead.MESSAGE_TYPE);
	// 海关平台返回的回执
	if (strPreFlag == "WEB")
	{
		...
		szLabel += m_messageHead.MESSAGE_TYPE; // CMessageType::CLM20022;
