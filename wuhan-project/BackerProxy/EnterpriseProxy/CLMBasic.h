...
public:
	...
	virtual void    SendResponse(const std::string &strPreFlag) = 0;
	virtual int		UpdateDB() = 0;
	virtual std::string GetFileName()	= 0;      

public:
	void ProcessMessage(structConfigInfo *pConfig, const std::string &strFileName, const std::string &strPreFlag);
