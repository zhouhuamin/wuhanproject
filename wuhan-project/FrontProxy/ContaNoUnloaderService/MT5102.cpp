...
{
	LOG3("Enter CMT5102::SendResponse, MessageType:%s, Sender:%s, Receiver:%s", m_mt5101.Head.MessageType.c_str(), m_mt5101.Head.SenderID.c_str(), m_mt5101.Head.ReceiverID.c_str());
