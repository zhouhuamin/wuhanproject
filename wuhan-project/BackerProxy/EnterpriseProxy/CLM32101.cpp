...
CCLM32101::CCLM32101(void) : m_messageHead(), m_billInfo(), m_respondInfo(), m_chOpFlag('F'), \
...
void CCLM32101::SendResponse(const std::string &strPreFlag)
{
	LOG1("CCLM32101::SendResponse:%s", strPreFlag.c_str());
...
int CCLM32101::SelectMQ(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
