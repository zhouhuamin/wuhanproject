...
CCLM10062::CCLM10062(void) : m_messageHead(), m_billInfo(), m_respondInfo(), m_chOpFlag('F'), \
m_chSEND_FLAG('1'), m_strNote(""),m_contaInfoVect(0)
{
}

CCLM10062::~CCLM10062(void)
{
}

void CCLM10062::InitConfigInfo(structConfigInfo *pConfig)
{
...
void CCLM10062::SaveFileName(const std::string &strFileName)
{
...
void CCLM10062::SendResponse(const std::string &strPreFlag)
{
	LOG1("CCLM10062::SendResponse:%s", strPreFlag.c_str());
	...
	for (int i = 0, j = 0; i < queueNameArray.GetSize() && j < mqIPArray.GetSize(); ++i,++j)
	{
		...
		std::string szLabel			= CMessageType::CLM10062;
...
std::string CCLM10062::GetFileName()
{
	return m_strFileName;
}

int CCLM10062::SelectMQ(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
...
int CCLM10062::SelectResponseInfo(CString &strMESSAGE_ID, CString &strOP_FLAG, CString &strNOTE)
{
...
int CCLM10062::InsertResponseInfo()
{
	if (m_respondInfo.MESSAGE_ID[0] == '\0')
		return 0;
...
int CCLM10062::DeleteResponseInfo()
{
	if (m_respondInfo.MESSAGE_ID[0] == '\0')
		return 0;
