...
CCLM20014::CCLM20014(void) : m_messageHead(), m_billInfo(), m_respondInfo(), m_chOpFlag('F'), \
m_chSEND_FLAG('1'), m_strNote(""),m_contaInfoVect(0)
{
}

CCLM20014::~CCLM20014(void)
{
}

void CCLM20014::InitConfigInfo(structConfigInfo *pConfig)
{
...
void CCLM20014::SaveFileName(const std::string &strFileName)
{
...
void CCLM20014::SendResponse(const std::string &strPreFlag)
{
	LOG3("Enter CCLM20014::SendResponse, MessageType:%s, Sender:%s, Receiver:%s", m_messageHead.MESSAGE_TYPE, m_messageHead.SENDER, m_messageHead.RECEIVE);
	// 海关平台返回的回执
	if (strPreFlag == "WEB")
	{
...
std::string CCLM20014::GetFileName()
{
	return m_strFileName;
}

int CCLM20014::SelectMQ(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
...
int CCLM20014::SelectResponseInfo(CString &strMESSAGE_ID, CString &strOP_FLAG, CString &strNOTE)
{
...
int CCLM20014::InsertResponseInfo()
{
	if (m_respondInfo.MESSAGE_ID[0] == '\0')
		return 0;
...
int CCLM20014::DeleteResponseInfo()
{
	if (m_respondInfo.MESSAGE_ID[0] == '\0')
		return 0;
...
int CCLM20014::SelectMQForWeb(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
		CStringArray mqPathArray;
