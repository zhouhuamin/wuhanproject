...
{
	LOG3("Enter CCSM001::SendResponse, MessageType:%s, Sender:%s, Receiver:%s", m_csm001.MessageHead.MessageType.c_str(), m_csm001.MessageHead.SenderID.c_str(), m_csm001.MessageHead.ReceiverID.c_str());
	if (m_csm001.MessageHead.MessageID.empty())
		return;
