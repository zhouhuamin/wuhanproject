...
CCLM20012::CCLM20012(void) : m_messageHead(), m_billInfo(), m_respondInfo(), m_chOpFlag('F'), \
m_chSEND_FLAG('1'), m_strNote(""),m_contaInfoVect(0)
{
}

CCLM20012::~CCLM20012(void)
{
}

void CCLM20012::InitConfigInfo(structConfigInfo *pConfig)
{
...
void CCLM20012::SaveFileName(const std::string &strFileName)
{
...
void CCLM20012::SendResponse()
{
	LOG3("Enter CCLM20012::SendResponse, MessageType:%s, Sender:%s, Receiver:%s", m_messageHead.MESSAGE_TYPE, m_messageHead.SENDER, m_messageHead.RECEIVE);
	//// 海关平台返回的回执
	//if (strPreFlag == "WEB")
	//{
...
std::string CCLM20012::GetFileName()
{
	return m_strFileName;
}

int CCLM20012::SelectMQ(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
...
int CCLM20012::SelectMQForWeb(CStringArray &queueNameArray, CStringArray &mqIPArray)
{
	try
	{
		CStringArray mqPathArray;
...
int CCLM20012::SelectResponseInfo(CString &strMESSAGE_ID, CString &strOP_FLAG, CString &strNOTE)
{
...
int CCLM20012::InsertResponseInfo()
{
	if (m_respondInfo.MESSAGE_ID[0] == '\0')
		return 0;
...
int CCLM20012::DeleteResponseInfo()
{
	if (m_respondInfo.MESSAGE_ID[0] == '\0')
		return 0;
